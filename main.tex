...
\end{align}
The modification, which is used in these tests is a twin network, where only one is used to obtain the policy, while the other is used for the update rule
