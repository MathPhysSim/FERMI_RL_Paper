...
\end{align}
where $p_\policy = \initstate(\bs_0)\prod_{t_0}^\horizon\policy(\ba_t,\bs_t)\transitions(s_{t+1}|s_t,a_t)$ is the distribution of all trajectories $\tau := (s_0, a_0, s_1, a_1,...s_H,a_H)$ drawn by $\pi$ with a horizon $H$.
