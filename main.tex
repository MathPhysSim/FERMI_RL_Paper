...
\Cref{fig:NAF_training} displays the results, averaged over the two test. A training of 100 episodes was done. In the upper figure the number of iterations per episode is plotted including the cumulative number of steps.
