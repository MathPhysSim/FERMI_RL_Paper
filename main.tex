...
Assume states $\s$ the set of all states $\states$ and actions $\ba$ all actions $\actions$ and rewards $\reward$ and the set of all rewards $\mathcal{R}$ an initial state distribution $\initstate$.
Goal of reinforcement learning is to find a $\policy$ $\states\mapsto \actions$, which is the solution of:
\begin{align}
