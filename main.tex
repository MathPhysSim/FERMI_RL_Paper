...
Assume states $s$ the set of all states $\states$ and actions $a$ all actions $\actions$ and rewards $r$ and the set of all rewards $\rewards$ an initial state distribution $d_0$.
