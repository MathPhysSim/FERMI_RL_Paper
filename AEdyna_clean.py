...
class NN:
    ...
    def anchor(self, lambda_anchor, sess):
        ...
        w1, b1, w = self.get_weights(sess=sess)
...
if __name__ == '__main__':
    aedyna('', hidden_sizes=hidden_sizes, num_epochs=num_epochs,
           steps_per_env=steps_per_env, algorithm='TRPO', model_batch_size=model_batch_size, simulated_steps=simulated_steps,
