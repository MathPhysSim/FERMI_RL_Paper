...
import numpy as np
project_directory = 'Data_logging/run_5/-nr_steps_20-cr_lr0.001-crit_it_80-d_0.05-conj_iters_10-n_ep_20-mini_bs_500-m_bs_100-mb_lr_0.001-sim_steps_2000-m_iter_15-ensnr_5-init_100/'
#'Data_logging/run_1/-nr_steps_25-cr_lr0.001-crit_it_80-d_0.05-conj_iters_10-n_ep_16-mini_bs_500-m_bs_100-mb_lr_0.0005-sim_steps_2000-m_iter_15-ensnr_5-init_300/'
...
def plot_results(data, label='test', **kwargs):
    # plotting
    print('now plotting')
    rewards = data
    print(rewards)
